...
#creating a conditinal python programming with while,for, break, if, elif, and else loops.
while True:
    ...
    #getting user ready to interact with the application
    print("\n And therefore we ask all new players to register basic infomation first\n ")
    ...
    #adding a descritive text of the first sim
    print(" Now will you run or Walk away from a stranger in black? \n\n ")
    print("A wierd looking men in black with a hat on sitting at the back of a strange house calling your full name\n \n ")
    print("1 - Run")
    print("2- Walk away")
    ...
    #start our if statement to macth or loop user input
    if action1 == "1":
        
        #determing the out come of user action taken
        ...
        if action2 == "1":
            ...
            if action3 == "1":
                    ...
                    # else if is used to make other options possible for user    
                    elif action4 == "2":
                        #    
                        print(" The strangers looked at each other and laugh because you won, \n its just your parents in prank")
                        
                        #else to ask user to stay according to code
                    else:
    ...
    # asking user wherther they want to continue the game                    
    replay = input("Do you want to try again? (Yes/No) :  ")
    
    
    #if user type yes the game starts over
    if replay.upper() != "YES" :
